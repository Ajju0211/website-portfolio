...
const Contact = () => {
  ...
  return (
      <div className="flex  items-center justify-center h-screen w-screen p-2">
          <div
              className="flex bg-gradient-to-r from-[#12100E] to-[#2B4162] flex-col bg-[#3c3c3c] bg-opacity-100  border-[#828282] shadow-black rounded-[10px] mb-20 md:h-[80%] md:w-[80%] h-[80%] w-[100%]"
